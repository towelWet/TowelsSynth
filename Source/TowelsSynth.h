...
class TowelsSynth : public juce::Synthesiser
{
public:
    ...
    class TowelsSound : public juce::SynthesiserSound
    {
    public:
        TowelsSound (juce::AudioProcessorValueTreeState& state);
    ...
    private:
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TowelsSound)
    };

    class TowelsVoice : public juce::SynthesiserVoice
    {
    public:
        TowelsVoice (juce::AudioProcessorValueTreeState& state);
    ...
    private:
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TowelsVoice)
    };

private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TowelsSynth)
};
